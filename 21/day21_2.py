...
for w in weapons.keys():
    ...
    me['armour'] = 0
    if battle(boss,me) == 'boss':
        wins.append(gold_spent)
        print(gold_spent)
     #  lost with a weapon so add just some armour
        for a in armour.keys():
            ...
            if battle(boss,me) == 'boss':
                wins.append(gold_spent)
                print(gold_spent)
            # still didn't win so now add a ring
                for r in rings.keys():
                    print("+++++++++++++", r)
                    ...
                    if battle(boss,me) == 'boss':
                        wins.append(gold_spent)
                        print(gold_spent)
                     # still didn't win so add a second ring
        ...
        for r in rings.keys():
            ...
            if battle(boss,me) == 'boss':
                wins.append(gold_spent)
                print(gold_spent)
             # didn't win so add a second ring
                for r2 in rings.keys():
                    if r2 != r: # can't have two of same ring
